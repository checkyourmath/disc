...
export const ManageMembersDialog = () => {
  ...
  const { openDialog, isDialogOpen, closeDialog, dialogType, dialogData } = useDialog();
  const [loadingId, setLoadingId] = useState("");

  const isOpen = isDialogOpen && dialogType === DialogType.SERVER_MANAGE_MEMBERS;
  ...
  const onKick = async (memberId: string) => {
    try {
      ...
      router.refresh();
      openDialog(DialogType.SERVER_MANAGE_MEMBERS, { server: response.data });
    } catch (error) {
      // TODO: handle error
